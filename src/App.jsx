                                                                    ...
                                                                    setSegments([]);
                                                                        setScreen("setup");
                                                                            ...
                                                                            if (screen === "setup") return <SetupScreen onStart={handleStart} />;
                                                                              if (screen === "spin") return <SpinScreen segments={segments} mode={mode} onResult={handleResult} onReset={handleReset} />;
                                                                                if (screen === "result") return <ResultScreen winner={winner} city={city} onSpinAgain={handleSpinAgain} onReset={handleReset} />;
                                                                                }
